...
int main() {
    ...
    // lambda used for comparison
    auto compareRating = [](const Course& c1, const Course& c2) -> bool {
    ...
    // check if the two characterrs is "cs"
    auto isDep = [department](auto element) -> bool {
